...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:Button ID="btnSearchBy" runat="server" Text="Search" OnClick="btnSearchBy_Click" ValidationGroup="SearchValidation" CausesValidation="true"/> <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter an ID" ValidationGroup="SearchValidation" ControlToValidate="tbxSearchBy" CssClass="input-error_message"/><br />
    <asp:RegularExpressionValidator runat="server" ErrorMessage="You must enter a postive number greater than zero" ValidationExpression="^[1-9]\d*$" ControlToValidate="tbxSearchBy" ValidationGroup="SearchValidation" CssClass="input-error_message"/>
    <br />
    <br />
