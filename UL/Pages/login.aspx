    ...
    <div class="grid-wrapper-login">
        ...
        <div class="grid-item grid-item-logincard">
            <div class="input-wrapper">
                <h1>Login</h1>
                <%-- panel designates button as default, for pressing enter --%>
                <asp:Panel ID="pnlLoginPanel" runat="server" DefaultButton="btnLogin">
                    ...
                    <div class="input-field">
                        ...
                        <asp:TextBox ID="tbxEmail" runat="server" 
                            ToolTip="Please enter a registered email." 
                    ...
                    <div class="input-field">
                        ...
                        <asp:TextBox ID="tbxPassword" 
                            runat="server" 
                            TextMode="Password" 
                            ToolTip="Please enter your password." 
                            CssClass="input-textbox" />

                        <span class="input-helper_text">
                            <asp:HyperLink ID="linkResetPassword" 
                                runat="server" 
                                Text="Forgotten your password?" 
                                NavigateUrl="~/UL/Pages/resetPassword.aspx" />
                        </span>
                    ...
                    <span class="input-helper_text">Haven't got an account yet?<br />
                        <asp:HyperLink ID="linkRegister" 
                            ...
                            NavigateUrl="~/UL/Pages/register.aspx" />
                    </span>
                </asp:Panel>
            </div>
        </div>
